...
export type BookPageBundle = {
    content: ReactNode;
    titlePage?: ReactNode;
};

/**
 * Open-book title and body content, keyed by book id. Books not listed here use inline `content` in the catalog or have no modal body.
 */
export const bookPages: Partial<Record<BookId, BookPageBundle>> = {
    wheatonCollege: {
        titlePage: (
            <div>
    ...
    bulletin: {
        ...
        content: (
            <div>
                <p>
                    Bulletin is a virtual flyer board android app that I built in collaboration with 3 other students as a
                ...
                <br />
                <a
                    href={'https://github.com/AnnaChason/Bulletin'}
                    target="_blank"
                    className={'text-blue-400 hover:text-brown-600'}
                >
                    View on Github
                </a>
            </div>
    ...
    flippy: {
        ...
        content: (
            <div>
                <p>
                    Flippy is an interactive flashcard website with multiple study modes including a smart review system to
                    track user progress over time. <br />
                    <br /> Built with:
                </p>
                <ul className={'ml-10'}>
                    <li>HTML</li>
                ...
                <br />
                <a
                    href={'https://github.com/AnnaChason/Flippy'}
                    target="_blank"
                    className={'text-blue-400 hover:text-brown-600'}
                >
                    View on Github
    ...
    portfolioWebsite: {
        ...
        content: (
            <div>
                <p>
                    This project is currently a work in progress, but I’m excited to share it! I decided to have some fun with
                    the design of the site and was inspired by my love of reading. It has been both challenging and rewarding,
                    giving me the chance to strengthen my skills in React and Tailwind especially.
                </p>
                <br />
                ...
                <br />
                <a
                    href={'https://github.com/AnnaChason/portfolio-site'}
                    target="_blank"
                    className={'text-blue-400 hover:text-brown-600'}
                >
                    View on Github
    ...
    labAssistant: {
        ...
        content: (
            <div className={'mt-3'}>
                <p className={'text-lg'}>
                    As a lab assistant, I support fellow students working in Wheaton College’s computer science lab, where CS
                    students collaborate on coursework and projects. I help students debug code, understand concepts, and make
                    progress on assignments for courses I have completed, drawing on my own experience to explain material
    ...
    gitGithub: {
        titlePage: (
            <div className={'text-center'}>
                <h1>GitHub</h1>
                <img src="https://ghchart.rshah.org/AnnaChason" alt="" />
            </div>
        ),
        content: (
            <div>
    ...
    proxyWebServer: {
        ...
        content: (
            <div>
                <p>
                    I built this web proxy in C which processes HTTP get requests.
                    <br />
                    <br /> It features:
                </p>
                <ul className={'ml-10'}>
    ...
    csClubCabinet: {
        ...
        content: (
            <div className={'mt-3'}>
                <p>
                    As the event coordinator of Wheaton's computer science club, I plan and events to foster community and
                    professional development among CS students. To do this, I work closely with the rest of the club cabinet
                    to delegate tasks and ensure the event runs smoothly. <br />
                    <br />
                    Some events I’ve helped coordinate include a ramen & résumé review night, an internship discussion ice
                    cream social, and a holiday social event.
                </p>
            </div>
        ),
    },
    diakonoi: {
        ...
        content: (
            <div className={'mt-3'}>
                <p>
                    Diakonoi is what Wheaton calls their Campus host programs. <br /> As a Diakonoi, I:
                </p>
                <ul className={'ml-10'}>
        ...
        content: (
            <div className={'content-center'}>
                <ul className={'ml-2 list-none space-y-4'}>
                    <li>
                        <span className={'font-bold'}>Email: </span>chasonwiggins@gmail.com
                    </li>
                    <li>
                        <span className={'font-bold'}>Phone: </span>(205)-305-2964
                    </li>
                    <li>
                        {' '}
                        <a href={'https://github.com/AnnaChason'} target="_blank" className={'text-blue-400 hover:text-brown-600'}>
                    ...
                    <li>
                        {' '}
                        <a
                            href={'https://www.linkedin.com/in/anna-wiggins-96419a320'}
                            target="_blank"
                            className={'text-blue-400 hover:text-brown-600'}
                        >
                            LinkedIn profile
                    ...
                    <li>
                        For book recommendations view my{' '}
                        <a
                            href={'https://www.goodreads.com/user/show/98177448-anna-chason-wiggins'}
                            target={'_blank'}
                            className={'text-blue-400 hover:text-brown-600'}
                        >
                            Goodreads profile
    ...
    csHub: {
        ...
        content: (
            <div className={'mt-3'}>
                <p>
                    The Wheaton College CS Hub is a website build to provide students with academic and vocational resources as
                    well as to build community among CS students.
                    <br />
                    <br />
                    To develop this website, I collaborated with a team of fellow student, using AI-assisted tools (primarily
                    ChatGPT, Claude, and Cursor) to design and build features while gaining experience in modern AI-supported
