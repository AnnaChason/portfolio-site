...
export const bookList: BookProps[] = [
    ...
    {title:"Supabase", color:"green", image:'none', content:bookContentPages[0], titlePage:bookTitlePages[0], className:'h-60'},
    {title:"React", color:"pink", image:reactLogo, content:bookContentPages[0], titlePage:bookTitlePages[0], className:'w-60'},
    //8-10: projects
