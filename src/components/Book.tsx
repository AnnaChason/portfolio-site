...
const Book: React.FC<BookProps> = ({
    ...
    return (
        <div className={"bg-white flex pr-1 pt-1 shadow-md rounded h-64 w-48 border-2 border-solid m-3 mb-0 hover:-translate-y-2 " + ColorMap["b" + color]}>
            <div className={"w-5 h-full " + ColorMap["d"+color]}></div>
            <div className={"rounded-r flex flex-wrap h-full flex-grow " + ColorMap[color]}>
