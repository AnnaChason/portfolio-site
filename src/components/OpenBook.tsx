...
const OpenBook: React.FC<OpenBookProps> = (
    ...
    return (
        ...
        <div className="flex m-1">
            <div className={"rounded-l flex justify-center h-96 w-72 p-3 pr-0 " + ColorMap[color]}>
                <div className={"bg-amber-50 w-full h-full flex items-center justify-center "}>
                    <h1 className={"text-stone-800 font-bold"}>{title}</h1>
                </div>
            </div>
            <div className={" flex justify-center h-96 pt-3 pb-3 w-5 " + ColorMap["d"+color]}>
            ...
            <div className={"rounded-r flex justify-center h-96 w-72 p-3 pl-0 " + ColorMap[color]}>
