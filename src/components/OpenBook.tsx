    ...
    return (
        <div>
            ...
            {/*book container*/}
                ...
                <div className="flex m-1  drop-shadow-lg h-[40rem] sm:h-[30rem] " onClick={(e) => e.stopPropagation()}>
                    {/*left side (title page)*/}
                    <div className={"rounded-l flex justify-center p-3 pr-0 w-52 sm:w-96 h-full "+ ColorMap[color]}>
                    ...
                    {/*middle (spine)*/}
                    <div className={"flex justify-center pt-3 pb-3 w-5 " + ColorMap["d"+color]}>
                    ...
                    <div className={"rounded-r flex justify-center w-52 sm:w-96 p-3 pl-0 " + ColorMap[color]}>
                        <div className={"bg-amber-50 w-full h-full p-3 flex pt-5 text-brown-900 text-md sm:text-lg overflow-y-scroll sm:overflow-y-hidden"}>
                            {content}
                        </div>
                    </div>
                </div>
